...
\begin{frame}
    ...
    \end{itemize}
    \footnotetext{physics – Macros supporting the Mathematics of Physics. \href{https://ctan.org/pkg/physics}{\textcolor{spruce_dark}{https://ctan.org/pkg/physics}}.}
\end{frame}
...
\begin{frame}
  ...
  \pause
    \begin{itemize}
        ...
        \footnotetext{amsmath – AMS mathematical facilities for \LaTeX. \href{https://ctan.org/pkg/amsmath}{\textcolor{spruce_dark}{https://ctan.org/pkg/amsmath}}.}
        \item[$\diamond$] \textcolor{vibrant_green}{\textit{amsfonts}}\footnotemark (styles calligraphiques: $\mathcal{A}, \mathcal{B}, \mathcal{C}$)
        \footnotetext{amsfonts – TeX fonts from the American Mathematical Society. \href{https://ctan.org/pkg/amsfonts}{\textcolor{spruce_dark}{https://ctan.org/pkg/amsfonts}}.}
        \item[$\diamond$] \textcolor{vibrant_green}{\textit{amsthm}}\footnotemark(théorèmes, preuves, définitions)
        \footnotetext{amsthm – Typesetting theorems (AMS style). \href{https://ctan.org/pkg/amsthm}{\textcolor{spruce_dark}{https://ctan.org/pkg/amsthm}}.}
    ...
    \end{itemize}
    \footnotetext{doublestroke – Typeset mathematical double stroke symbols. \href{https://ctan.org/pkg/doublestroke}{\textcolor{spruce_dark}{https://ctan.org/pkg/doublestroke}}.}
\end{frame}
